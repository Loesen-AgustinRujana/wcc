        ...
        <div className="divide-y divide-gray-400 sm:divide-gray-200">
          <div className="hidden md:block bg-gray-50 p-3">
            <div className="grid grid-cols-2 md:grid-cols-8">
              ...
              <div className="flex items-center">
                <p className="text-sm text-black font-medium">Version</p>
              </div>
              <div className="flex items-center">
                <p className="text-sm text-black font-medium">Motor</p>
              </div>
              <div className="flex items-center">
                <p className="text-sm text-black font-medium">Country</p>
              </div>
            </div>
          </div>
